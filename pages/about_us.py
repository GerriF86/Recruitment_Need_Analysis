...
def about_us():
    ...
    - **Our Mission**: Provide the best experience for our users.
    - **Our Vision**: Innovate, adapt, and succeed.

    Feel free to reach out if you'd like to know more about us!
    """)

    st.image("image2.jpg", caption="Collaboration and Innovation")